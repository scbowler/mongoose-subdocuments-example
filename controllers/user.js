...
exports.addUser = function(req, res, next){
    const newUser = new User({
        googleId: 'asdfasdfasdfGoogle',
        username: 'The only user'
    });
...
exports.editPage = function(req, res, next){
    User.findById('5a557a0c7b71075f968f0983').then(function(user, err){
        ...
        const page = user
            .binders.id('5a557e9350f28e6019423369')
            .tabs.id('5a55879fc94b55614a3baeb3')
            .pages.id('5a558ae2206a4b61c785a630');

        
        page.page_color = req.query.color || page.page_color;
        page.page_name = req.query.name || page.page_name;
